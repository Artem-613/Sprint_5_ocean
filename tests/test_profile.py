...
class TestProfile:
    ...
    def test_navigate_to_personal_account(self, driver, wait, login_user):
    ...
    def test_navigate_from_profile_to_constructor_via_button(self, driver, wait, login_user):
    ...
    def test_navigate_from_profile_to_constructor_via_logo(self, driver, wait, login_user):
    ...
    def test_logout(self, driver, wait, login_user):
        """Выход из аккаунта"""
        login_user()
        driver.find_element(*Locators.button_personal_account).click()
